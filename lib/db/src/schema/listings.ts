...
export const listingsTable = pgTable("listings", {
  ...
  productType: text("product_type").notNull().default("3d_printing"),
  equipmentUsed: integer("equipment_used").array().default([]),
  equipmentGroups: integer("equipment_groups").array().default([]),
  ...
  digitalFiles: text("digital_files").array().default([]),
  stockType: text("stock_type").notNull().default("inventory"),
