      ...
      <main className="flex-grow pt-12 pb-24">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="glass-panel rounded-3xl border border-white/10 p-8 text-zinc-300 space-y-6 leading-7">
            <p>SYNTHIX connects buyers with independent makers and fabrication shops.</p>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-12 pb-24">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="glass-panel rounded-3xl border border-white/10 p-8 text-zinc-300 space-y-6 leading-7">
            <p>SYNTHIX stores account, listing, order, and conversation data needed to operate the marketplace.</p>
