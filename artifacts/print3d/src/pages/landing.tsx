                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {filteredItems.slice(0, 6).map((item, index) => (
                        ...
                        >
                          <Link href={item.link}>
                            <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg overflow-hidden hover:border-pink-500/50 transition-all duration-300 h-full">
                              <div className="bg-gradient-to-br from-zinc-800 to-zinc-900 relative overflow-hidden aspect-[3/2]">
                                {item.image ? (
                                  <img 
                                    src={item.image} 
                                    alt={item.title}
