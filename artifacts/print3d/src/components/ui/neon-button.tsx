...
export const NeonButton = React.forwardRef<HTMLButtonElement, NeonButtonProps>(
  ({ className, glowColor = "primary", children, ...props }, ref) => {
    const glowClasses = {
      primary: "shadow-[0_0_20px_rgba(139,92,246,0.3),0_0_40px_rgba(139,92,246,0.2)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5),0_0_60px_rgba(139,92,246,0.3)] border-primary/40 bg-gradient-to-r from-primary via-purple-500 to-accent bg-[length:200%_200%] animate-gradient-shift text-white hover:scale-105 transition-all duration-500",
      accent: "shadow-[0_0_20px_rgba(6,182,212,0.3),0_0_40px_rgba(6,182,212,0.2)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5),0_0_60px_rgba(6,182,212,0.3)] border-accent/40 bg-gradient-to-r from-accent via-primary to-accent bg-[length:200%_200%] animate-gradient-shift text-white hover:scale-105 transition-all duration-500",
