...
// ==================== API BASE URL ====================
// This will automatically use the value from Render (VITE_API_URL)
...
export async function customFetch<T = unknown>(
  ...
  let finalUrl = resolveUrl(input);
  if (!finalUrl.startsWith("http://") && !finalUrl.startsWith("https://")) {
    // Prepend the backend base URL for relative paths like "/sellers?limit=4"
