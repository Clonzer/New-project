...
export function SimpleSidebar() {
  ...
  const handleToggleAcceptingOrders = async () => {
    ...
    try {
      const newValue = !user?.acceptingOrders;
        ...
        <div className="flex flex-col h-full pt-16 pb-2">
          ...
          <div className="px-3 py-3 border-b border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0 flex-1 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div className="flex items-center justify-between mt-2 p-2 bg-zinc-800/50 rounded-lg">
                  ...
                  <button
                    ...
                    className="relative inline-flex h-4 w-8 items-center rounded-full transition-colors bg-green-600 cursor-pointer"
                  >
                    <span
                      className={`inline-block h-2 w-2 transform rounded-full bg-white transition-transform ${
                        user?.acceptingOrders ? 'translate-x-4' : 'translate-x-1'
                      }`}
                    />
                  </button>
                </div>
