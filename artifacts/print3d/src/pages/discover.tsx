...
import { Heart, MessageCircle, Share, User, Search, Plus } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {listingsData?.listings
                    ...
                    .map((listing) => (
                      <div key={listing.id} className="glass-panel rounded-3xl border border-white/10 p-6">
                        <img
                          src={listing.imageUrls?.[0] || "/api/placeholder/300/200"}
                          alt={listing.title}
            ...
            {activeTab === "people" && (
              <div className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {usersData?.users
                    .filter(u => u.role === "seller" && u.displayName.toLowerCase().includes(search.toLowerCase()))
                    .map((person) => (
                      <div key={person.id} className="glass-panel rounded-3xl border border-white/10 p-6">
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <div>
                            <h3 className="font-bold text-white">{person.displayName}</h3>
                            <p className="text-zinc-400 text-sm">{person.bio?.slice(0, 50)}...</p>
                          </div>
                        </div>
                        <div className="flex gap-2">
